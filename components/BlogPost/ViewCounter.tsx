...
export default function ViewCounter({ slug, readOnly = false, badge = false, inline = false }: { slug: string; readOnly?: boolean; badge?: boolean; inline?: boolean }) {
  ...
  if (badge || inline) {
    return (
      <span className={inline ? styles.viewBadgeInline : styles.viewBadge}>
